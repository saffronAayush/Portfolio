...
const DRIVE_FILE_ID = "1n5s1qb3frMaVwoNntH5qTvt22Wp7FF_C";

const pdfPreviewUrl = `https://drive.google.com/file/d/${DRIVE_FILE_ID}/preview`;
const pdfDownloadUrl = `https://drive.google.com/uc?export=download&id=${DRIVE_FILE_ID}`;
const pdfRedirectUrl = `https://drive.google.com/file/d/1n5s1qb3frMaVwoNntH5qTvt22Wp7FF_C/view?usp=drive_link`;
